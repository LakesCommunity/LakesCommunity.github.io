      ...
      compile: function uiMaskCompilingFunction(){
        ...
        return function uiMaskLinkingFunction(scope, iElement, iAttrs, controller){
          ...
          function parser(fromViewValue){
            ...
            // to be out-of-sync with what the controllers's $viewValue is set to.
          ...
          function unmaskValue(value){
            ...
            // Preprocess by stripping mask user from value
          ...
          // Generate array of mask user that will be stripped from a masked value
          // before processing to prevent mask user from being added to the unmasked value.

...
.provider('$analytics', function () {
  ...
  // As handlers are installed by plugins, they get pushed into a home and invoked in order.
  ...
  return {
    ...
    link: function ($scope, $element, $attrs) {
      ...
      angular.element($element[0]).bind(eventType, function ($event) {
        ...
        // Allow user to pass through an expression that gets merged on to the event properties
